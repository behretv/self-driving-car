...
class SessionHandler:
    ...
    def train(self, step):
        ...
        batch_count = int(math.ceil(len(feature_train) / self.__params.batch_size))
        ...
        with tf.Session() as self.__session:
            ...
            for i in range(self.params.epochs):
                ...
                for batch_i in batches_pbar:
                    ...
                    self.__session.run(self.cnn.optimizer, feed_dict={
    ...
    def validate(self):
        ...
        for i_start in range(0, n_features, self.params.batch_size):
            ...
            tmp_accuracy = tmp_sess.run(self.cnn.cost, feed_dict={
    ...
    def test(self, step):
        ...
        with tf.Session() as sess:
            ...
            test_accuracy = sess.run(self.cnn.cost, feed_dict={
